...
func TestCustomValidator(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedError:  true,
			expectedFields: []string{"monthly_income"},
		},
		{
			...
			expectedStatus: http.StatusBadRequest,
			expectedError:  true,
			expectedFields: []string{"investment_return"},
		},
		{
		...
		},
		{
			...
			expectedStatus: http.StatusBadRequest,
			expectedError:  true,
			expectedFields: []string{"monthly_income", "investment_return", "email", "category"},
		},
		{
			...
			expectedStatus: http.StatusBadRequest,
			expectedError:  true,
			expectedFields: []string{"monthly_income", "email", "category"},
		},
		{
