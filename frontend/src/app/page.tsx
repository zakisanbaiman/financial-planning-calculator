    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <div className="card">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">財務データ管理</h3>
          <p className="text-gray-600 mb-4">
            収入、支出、貯蓄状況を入力・管理して、正確な将来予測の基盤を作成
          </p>
          <Link href="/financial-data" className="text-primary-600 hover:text-primary-700 font-medium">
            詳細を見る →
          </Link>
        </div>
        ...
        <div className="card">
          ...
          <Link href="/calculations" className="text-primary-600 hover:text-primary-700 font-medium">
            計算してみる →
          </Link>
        </div>
        ...
        <div className="card">
          <div className="text-3xl mb-4">🎯</div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">目標設定・進捗管理</h3>
          <p className="text-gray-600 mb-4">
        ...
        <div className="card">
          <div className="text-3xl mb-4">📋</div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">レポート生成</h3>
          <p className="text-gray-600 mb-4">
            財務状況をまとめたレポートをPDF形式で生成・印刷
          </p>
          <Link href="/reports" className="text-primary-600 hover:text-primary-700 font-medium">
            レポート作成 →
          </Link>
        </div>
      </div>
      ...
      <div className="card max-w-2xl mx-auto text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">はじめ方</h2>
        <div className="space-y-4 text-left">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900">財務データを入力</h4>
              <p className="text-gray-600 text-sm">現在の収入、支出、貯蓄額を入力してください</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900">目標を設定</h4>
              <p className="text-gray-600 text-sm">達成したい財務目標を設定しましょう</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900">計算・可視化</h4>
              <p className="text-gray-600 text-sm">将来の資産推移や必要資金を確認してください</p>
            </div>
          </div>
        </div>
      </div>
